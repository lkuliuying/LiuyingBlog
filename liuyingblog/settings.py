...
# ==========================================
# Database
# 通过 .env 配置：DB_ENGINE 支持 sqlite / mysql / postgresql，默认 sqlite
# ==========================================
...
if _db_engine == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'liuyingblog'),
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': _db_name if os.path.isabs(_db_name) else BASE_DIR / _db_name,
        }
    }
